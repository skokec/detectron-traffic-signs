...
YAML definition files of detectron models for the [DFG-dataset](https://www.vicos.si/Downloads/DFGTSD) are available below:
 - [detectron-model-yaml-DFG-dataset.zip](https://data.vicos.si/skokec/villard/detectron-model-yaml-DFG-dataset.zip)
 - [detectron-model-yaml-DFG-dataset-augmented.zip](https://data.vicos.si/skokec/villard/detectron-model-yaml-DFG-dataset-augmented.zip)
...
You can download weights trained on DFG-Dataset for the upper model in:
 - [dfg_mask_rcnn_weights.tar.gz](https://data.vicos.si/skokec/villard/dfg_mask_rcnn_weights.tar.gz)
