...
and gradient computation.
    ...
    .Input(
        2,
        "weights",
        "Tensor of weights of type float and same shape as logits X.")
    .Output(
        0,
        "loss",
        "Scalar loss.");
...
REGISTER_GRADIENT(WeightedSigmoidCrossEntropyLoss, GetWeightedSigmoidCrossEntropyLossGradient);
